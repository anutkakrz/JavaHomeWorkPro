...
//@AllArgsConstructor
//
//public class OfficeEquipment_List {
//    int id;
//    String modelName;
//    String manufacturer;
...
//    }
//
//    public static OfficeEquipment_List[] getFullArray() {
//        Random random = new Random();//
//        Faker faker = new Faker();
//        Class<? extends OfficeEquipment_List>[] classes = new Class[]{Laptop.class, Monitor.class,
//                Phone.class, Printer.class, Projector.class, Router.class, Scanner.class,
//                Switch.class, Tablet.class};
//        OfficeEquipment_List[] officeObjects = new OfficeEquipment_List[10];
//
//        for (int i = 0; i < officeObjects.length; i++) {
//            int randomIndex = random.nextInt(classes.length);
//            Class<? extends OfficeEquipment_List> selectedClass = classes[randomIndex];
//
